...
async function submitNewTicket(req: any, res: any) {
    ...
    try{
        //is the assigned user on the project?
    ...
    if(userTeamRoleIds.roleID === Roles.Legend.owner || isUserOnProject === true){
        try{
            ...
            await tickets.addTicket(req, res, userTeamIDCombo, targetUserId.user_id, ticketPriority)
...
module.exports = { submitNewTicket, getTickets }