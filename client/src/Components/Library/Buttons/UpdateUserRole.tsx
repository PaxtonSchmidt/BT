    ...
    <>
      {isOpen ? (
        <div style={{ marginBottom: '10px' }}>
          <span
            id='RoleUpdate'
            className='fadeIn inComponentButton scaleYonHover'
            onClick={() => handleClick('Project Lead')}
          ...
          <span
            id='RoleUpdate'
            className='fadeIn inComponentButton scaleYonHover resetRolesButton'
            onClick={handleReset}
            style={{ display: 'inline-block', width: 'fit-content' }}
          >
            <div>X</div>
        ...
        <div className='memberListRowSection'>
          ...
          {props.isFormDirty ? (
            <span
              id='RoleUpdate'
              className='inComponentButton scaleYonHover resetRolesButton'
              onClick={handleReset}
              style={{ display: 'inline-block', width: 'fit-content' }}
            >
              <div>X</div>
