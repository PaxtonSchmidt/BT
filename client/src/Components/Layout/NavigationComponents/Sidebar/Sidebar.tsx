...
export default function Sidebar(props: Props) {
    ...
    return (
        <div
            className='sideBar navComponent fadeIn'
            ...
            <div>
                <div
                    ...
                    onClick={() => handleSelect(destinations.tickets)}>
                ...
                <div
                    ...
                    onClick={() => handleSelect(destinations.projects)}>
                    <div className='sidebarIconContainer'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='28'
                ...
                {isTeamOwnerOrLead ? (
                    ...
                    ${
                        ...
                        onClick={() => handleSelect(destinations.team)}>
                        <div className='sidebarIconContainer'>
                            <svg
                                xmlns='http://www.w3.org/2000/svg'
                                width='28'
