...
import { AlertActionCreators, FocusedMemberActionCreators, FocusedProjectActionCreators } from '../../../../Redux';
...
export default function TeammateProjectButton(props: Props) {
    ...
    function handleSelect(){
        let projectIDX = sessionState.currentTeam.projects.findIndex((project: Project)=>{return project.name === props.Project})
