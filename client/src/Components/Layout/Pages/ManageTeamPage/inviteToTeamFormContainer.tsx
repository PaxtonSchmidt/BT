...
export default function InviteToTeamForContainer(){
    ...
    function handleOpenProjectForm(){
        if(isExtended === false){
            ...
            document.getElementById('bi-arrow-bar-down')!.classList.add('noPadding');       
        } else{
    ...
    return (
        <div id='pageContentContainer' className='FormContainer fadeIn' style={{display: 'flex', alignItems: 'center'}}>
            ...
            <div className='formLoadAnim'>
                <h1 onClick={handleOpenProjectForm} className='button svgSibling' style={{width: '100%', cursor: 'pointer', backgroundColor: 'transparent', marginBottom: '0px', marginTop: '3px', marginRight:'0px'}}>Invite Someone</h1>
                <svg onClick={handleOpenProjectForm} style={{paddingRight: '0px'}} id='bi-arrow-bar-down' xmlns="http://www.w3.org/2000/svg" width="100%" height="25" fill="currentColor" className="bi bi-arrow-bar-down" viewBox="0 0 16 16">
