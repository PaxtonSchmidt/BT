...
export default function TicketFormContainer(props: Props) {
  ...
  const [isTicketFormDisabled, setIsTicketFormDisabled] =
  ...
  return (
    ...
    >
      <div className='formLoadAnim'>
        ...
        />
        <h1
          onClick={() => handleSetIsExtended()}
          className='button svgSibling'
          style={{
            cursor: `${isTicketFormDisabled ? 'default' : 'pointer'}`,
            backgroundColor: 'transparent',
            marginBottom: '0px',
            marginLeft: '0px',
            paddingLeft: '5px',
            color: `${isTicketFormDisabled ? '#ffffff31' : ''}`,
          }}
        >
          Create Ticket
        </h1>
        <svg
          ...
          height='25'
          fill='currentColor'
          className={`bi bi-arrow-bar-down ${isTwisted} ${isFormDisabled}`}
          viewBox='0 0 16 16'
        >
          <path
            fillRule='evenodd'
