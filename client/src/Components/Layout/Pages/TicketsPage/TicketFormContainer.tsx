    ...
    return(
        <Container id='FormContainer' className='pageBodyContainer2 FormContainer fadeIn'>
            <div className='formLoadAnim'>
                <TicketForm isExtended={isExtended}/>
                <h1 onClick={handleOpenTicketForm} className='button svgSibling' style={{width: '100%', cursor: 'pointer', backgroundColor: 'transparent', marginBottom: '0px'}}>Create Ticket</h1>
