...
export default function ProjectPriorityChart(props: Props) {
  ...
  function setNewDataArray() {
    ...
    let medVal: number = 0;
    let lowVal: number = 0;
    if (props.data.High !== undefined) {
      highVal = props.data.High;
    }
    if (props.data.Medium !== undefined) {
      medVal = props.data.Medium;
    }
    if (props.data.Low !== undefined) {
      lowVal = props.data.Low;
    }
