...
export default function ProjectAssigneeChart(props: Props){
    ...
    function setNewDataArray(){
        ...
        props.data?.forEach((stat: AssigneeStatistic) => {
            ...
            let dataItem: DataEntry = {title: itemTitle, color: '#222222', value: stat.amount, discriminator: discriminator}
        ...
        return (
            ...
            label={({x, y, dx, dy, dataEntry})=>
                <text dominantBaseline='central' x={x} y={y} dx={dx} dy={dy} >
                    ...
                    <tspan className='discriminator chartLabel' dy={.5} style={{fontSize:'3px', paddingTop:'2px'}}>
