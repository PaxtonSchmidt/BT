    ...
    return(
        <Container id='FormContainer' className='pageBodyContainer2 FormContainer fadeIn'>
            <div className='formLoadAnim'>
                ...
                <h1 onClick={handleOpenProjectForm} className='button svgSibling' style={{width: '100%', cursor: 'pointer', backgroundColor: 'transparent', marginBottom: '0px'}}>Create Project</h1>
