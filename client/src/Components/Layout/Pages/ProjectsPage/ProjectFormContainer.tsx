    ...
    return(
        <Container id='FormContainer' className='pageBodyContainer2 FormContainer fadeIn'>
            <div className='formLoadAnim'>
                <ProjectForm isExtended={props.isExtended} setIsExtended={props.setIsExtended}/>
                ...
                <svg onClick={handleOpenProjectForm} id='bi-arrow-bar-down' xmlns="http://www.w3.org/2000/svg" width="100%" height="25" fill="currentColor" className={`bi bi-arrow-bar-down ${props.isExtended ? 'twist' : ''}`} viewBox="0 0 16 16">
